  ...
  return (
    <div className="bg-[#f7f9fb] dark:bg-gray-900 text-[#191c1e] dark:text-gray-100 min-h-screen pb-32 font-['Montserrat'] antialiased flex flex-col transition-colors duration-300">
      ...
      <header className="fixed top-0 left-0 w-full z-50 bg-[#f7f9fb] dark:bg-gray-900 h-16 flex items-center px-4 border-b border-gray-200 dark:border-gray-800 transition-colors duration-300">
        ...
        <h1 className="text-xl font-bold text-[#143867] dark:text-blue-400 transition-colors duration-300">{t.app.settings}</h1>
      </header>
      ...
      <main className="pt-24 px-4 max-w-4xl mx-auto w-full flex-grow">
        ...
        <section className="mb-6">
          <h2 className="text-xs font-bold text-gray-400 dark:text-gray-500 uppercase tracking-widest mb-3 px-1 transition-colors duration-300">{t.settings.account}</h2>
          <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm overflow-hidden transition-colors duration-300">
            <button className="w-full flex items-center justify-between px-5 py-4 hover:bg-gray-50 dark:hover:bg-gray-750 transition-colors active:bg-gray-100 dark:active:bg-gray-700">
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm font-semibold text-[#143867] dark:text-gray-200 transition-colors duration-300">{t.settings.change_password}</span>
              </div>
        ...
        {/* Appearance Section */}
        <section className="mb-6">
          <h2 className="text-xs font-bold text-gray-400 dark:text-gray-500 uppercase tracking-widest mb-3 px-1 transition-colors duration-300">{t.settings.appearance}</h2>
          <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm overflow-hidden transition-colors duration-300">
            <div className="flex items-center justify-between px-5 py-4">
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm font-semibold text-[#143867] dark:text-gray-200 transition-colors duration-300">{t.settings.theme}</span>
              </div>
              <button
                onClick={toggleTheme}
            ...
            <div className="px-5 pb-4">
              <span className="text-xs text-gray-400 dark:text-gray-500 font-medium transition-colors duration-300">
                {isDarkMode ? (t.settings.dark_enabled) : (t.settings.light_enabled)}
              </span>
            </div>
          </div>
        </section>
        ...
        {/* Activity Section */}
        <section className="mb-6">
          <h2 className="text-xs font-bold text-gray-400 dark:text-gray-500 uppercase tracking-widest mb-3 px-1 transition-colors duration-300">{t.settings.activity}</h2>
          <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm overflow-hidden p-5 transition-colors duration-300">
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-sm font-semibold text-[#143867] dark:text-gray-200 transition-colors duration-300">{t.settings.tournament_history}</span>
            </div>
            <div className="grid grid-cols-2 gap-3">
              <div className="bg-[#f0f4f8] dark:bg-gray-700 rounded-xl p-4 border border-gray-100 dark:border-gray-600 transition-colors duration-300">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-[10px] font-bold text-gray-400 dark:text-gray-400 uppercase tracking-wider transition-colors duration-300">{t.settings.physics}</span>
                </div>
              ...
              <div className="bg-[#f0f4f8] dark:bg-gray-700 rounded-xl p-4 border border-gray-100 dark:border-gray-600 transition-colors duration-300">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-[10px] font-bold text-gray-400 dark:text-gray-400 uppercase tracking-wider transition-colors duration-300">{t.settings.math}</span>
                </div>
        ...
        {/* Support Section */}
        <section className="mb-6">
          <h2 className="text-xs font-bold text-gray-400 dark:text-gray-500 uppercase tracking-widest mb-3 px-1 transition-colors duration-300">{t.settings.support}</h2>
          <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm overflow-hidden transition-colors duration-300">
            <button className="w-full flex items-center justify-between px-5 py-4 hover:bg-gray-50 dark:hover:bg-gray-750 transition-colors active:bg-gray-100 dark:active:bg-gray-700">
              <div className="flex items-center gap-3">
                <span className="material-symbols-outlined text-[#143867] dark:text-blue-400 transition-colors duration-300">feedback</span>
                <span className="text-sm font-semibold text-[#143867] dark:text-gray-200 transition-colors duration-300">{t.settings.send_feedback}</span>
              </div>
              <span className="material-symbols-outlined text-gray-400 dark:text-gray-500 text-xl transition-colors duration-300">chevron_right</span>
            </button>
            <div className="h-px bg-gray-100 dark:bg-gray-700 mx-5 transition-colors duration-300"></div>
            <button className="w-full flex items-center justify-between px-5 py-4 hover:bg-gray-50 dark:hover:bg-gray-750 transition-colors active:bg-gray-100 dark:active:bg-gray-700">
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm font-semibold text-[#143867] dark:text-gray-200 transition-colors duration-300">{t.settings.help_center}</span>
              </div>
              <span className="material-symbols-outlined text-gray-400 dark:text-gray-500 text-xl transition-colors duration-300">chevron_right</span>
            </button>
          </div>
        ...
        <section className="mb-6">
          ...
          >
            ...
            {isLoggingOut ? (t.app.logging_out) : (t.app.logout)}
          </button>
        </section>
